...
# Handle starting sentence with fuzzy matching
    ...
    try:
        ...
        try:
            ...
            if best_match_index == -1:
                await update.message.reply_text("یہ جملہ پی ڈی ایف میں نہیں ملا۔ براہ کرم درست جملہ بھیجیں یا دوسرا جملہ آزمائیں۔")
                return ASK_SENTENCE
            else:
